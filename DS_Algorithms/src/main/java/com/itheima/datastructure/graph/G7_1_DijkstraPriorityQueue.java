 ...
 */
public class G7_1_DijkstraPriorityQueue {
    ...
    private static void dijkstra(List<Vertex> graph, Vertex source) {
        /*
         * 注意:这里使用了优先队列,访问邻居修改距离后又把节点加进去,(但是原来里面就有的那个不会删除,其实会造成重复的,
         * 因为必须重新添加才会重新排序,所以重复是必要的,且每轮都找头节点,然后删,所以即使重复就会直接删掉怕,也不会有影响
         */
...
//            System.out.println(queue);
            // 3. 找一个节点作为 当前顶点( 找距离最小的节点,作为当前节点)在这里用优先队列了,那用第一个就行~
